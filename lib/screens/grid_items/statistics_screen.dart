...
class TileSection {
  ...
  TileSection(this.title, this.color, this.icon);
}
...
class _ByCountryWidgetState extends State<ByCountryWidget> {
  ...
  refreshData() {
    ...
    var response = NetworkService.fetchData(baseURL + countryName);
  ...
  void initState() {
    super.initState();
    _briefTilesSections = [
      TileSection("Total cases", Colors.blue, Icons.text_rotation_angledown),
      TileSection("Recovered", Colors.green, Icons.text_rotation_angledown),
      TileSection("Active", Colors.pinkAccent, Icons.text_rotation_angledown),
      TileSection("Death", Colors.red.shade700, Icons.text_rotation_angledown),
    ];
  }
              ...
              lineBarsData: [
                LineChartBarData(
                  ...
                  belowBarData: BarAreaData(
                    show: true,
                    colors: [Colors.black, Colors.orange].map((color) => color.withOpacity(0.3)).toList(),
                  ),
                ),
              ],
            )))

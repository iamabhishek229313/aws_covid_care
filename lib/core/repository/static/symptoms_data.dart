class SymptomsModel {
  ...
  SymptomsModel({this.title, this.description, this.imageURL});
}
...
List<SymptomsModel> symptomsData = [
  ...
  SymptomsModel(
    title: 'Fatigue',
    description: 'Joint Pain and Exhuastion has also been noted in rare cases of COVID-19.',
    imageURL: 'https://boilerplate.in/covid19/fatigue.png',
  ),
  SymptomsModel(
    title: 'Tierdness',
    description: 'You might find yourself feeling dehydrated. Muscle soreness has also been noted in some cases.',

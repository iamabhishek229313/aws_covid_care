class MythBusterModel {
  ...
  MythBusterModel({this.myth, this.fact});
}

List<MythBusterModel> mythBusterData = [
  MythBusterModel(
    myth: 'Antibiotics are effective in treating and preventing the new coronavirus?',
    fact:
  ...
  MythBusterModel(
    myth: 'A viral post on social media claims that bitter groud juice can treat coronavirus',
  ...
  MythBusterModel(
    ...
    fact: 'Drinking alcohol doesn\'t protect one from COVID-19 and can be dangerous for one\'s health',
  ),
  MythBusterModel(
    myth: 'Mosquito bites get one infected with COVID-19',
    fact: 'COVID-19 doesn\'t spread from mosquite bite but through droplets spread when an infected person sneezes',
  ),
  MythBusterModel(
    myth: 'Getting the pneumonia vaccine, protects one against the virus',
    fact: 'It helps against pneumonia but doesn\'t have a protective effective against coronavirus',
  ),
  MythBusterModel(
  ...
  MythBusterModel(
    myth: 'WHO has advised against eating bakery items as they get infected with virus easily',
    fact: 'WHO hasn\'t released any advisory regarding the same',
  ),
  MythBusterModel(
    myth: 'Regularly rinsing the nose with saline help prevent infection with the coronavirus',
    fact:
        'There is no evidence that regularly rinsing the nose with saline has protected people from infection with the coronavirus',
  ),
  MythBusterModel(
    myth: 'Cold weather and snow can kill the coronavirus',
    fact: 'There is no reason to believe that cold weather can kill the coronavirus',
  ),
  MythBusterModel(
    myth: 'Eating food cooked in mustard oil will protect you against coronavirus',
    fact: 'There\'s no such evidence that eating food cooked from mustard oil will protect you against coronavirus',
  ),
  MythBusterModel(
